...
class Evento(models.Model):
    ...
    categoria_FK         = models.ForeignKey(Categoria, related_name='evento', max_length=10, on_delete=models.CASCADE) # 'categoria.Categoria'
    tipoEvento_FK        = models.ForeignKey(TipoEve, related_name='evento', max_length=10, on_delete=models.CASCADE, default=True) # tipoEvento.TipoEvento
    ...
    lugar_FK             = models.ForeignKey(Lugar, related_name='evento', max_length=10, on_delete=models.CASCADE) # 'lugar.Lugar'
